...
export const metadata = {
  title: "Webinars & Live Streams | Digital Age Expo",
  description: "Join live virtual webinars hosted by industry experts across marketing, sales, AI, and digital growth.",
};
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-purple-950 via-slate-950 to-slate-950 px-6 py-16 text-center border-b border-white/10">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tight text-white">
            Virtual <span className="brand-gradient-text">Webinars</span>
          </h1>

          <p className="text-sm sm:text-base text-slate-300 max-w-2xl mx-auto font-medium">
            Interactive live stream sessions with live Q&amp;A, expert panels, and audience polls.
          </p>
        </div>
      </div>

      <EventDaysTabSection categoryTitle="WEBINARS SPEAKERS" enrollText="Enroll as Webinars Speaker" days={days} zoneKeyword="webinar" />
    </div>
  );
}
