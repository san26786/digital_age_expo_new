...
export const metadata = {
  title: "Seminars | Digital Age Expo",
  description: "Educational seminars and panel debates covering market trends, technology, and business strategy.",
};
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-purple-950 via-slate-950 to-slate-950 px-6 py-16 text-center border-b border-white/10">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tight text-white">
            Educational <span className="brand-gradient-text">Seminars</span>
          </h1>

          <p className="text-sm sm:text-base text-slate-300 max-w-2xl mx-auto font-medium">
            Inspirational seminar sessions led by industry pioneers across technology, finance, and marketing.
          </p>
        </div>
      </div>

      <EventDaysTabSection categoryTitle="SEMINARS SPEAKERS" enrollText="Enroll as Seminar Speaker" days={days} zoneKeyword="seminar" />
    </div>
  );
}
