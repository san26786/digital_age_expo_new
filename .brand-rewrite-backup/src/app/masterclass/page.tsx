...
export const metadata = {
  title: "Masterclasses | Digital Age Expo",
  description: "Hands-on, deep-dive masterclasses delivered by industry specialists.",
};
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-purple-950 via-slate-950 to-slate-950 px-6 py-16 text-center border-b border-white/10">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tight text-white">
            Expert <span className="brand-gradient-text">Masterclasses</span>
          </h1>

          <p className="text-sm sm:text-base text-slate-300 max-w-2xl mx-auto font-medium">
            Intensive learning sessions covering actionable strategies, tech frameworks, and business execution.
          </p>
        </div>
      </div>

      <EventDaysTabSection categoryTitle="MASTERCLASS SPEAKERS" enrollText="Enroll as Masterclass Speaker" days={days} zoneKeyword="masterclass" />
    </div>
  );
}
